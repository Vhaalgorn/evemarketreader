...
var searchString = [{blueprint_typeID:11394}] //at this point the typeID will always be a blueprint_typeID
var searchString2 = 11394
...
async function get_blueprintTypeID(item_typeID){
    let result = await new Promise((resolve, reject)=>{
        connection.query(`SELECT typeID as blueprint_typeID FROM industryActivityProducts WHERE productTypeID=${item_typeID}`, (err,result)=>{
            if (err) reject(err)
            else{
